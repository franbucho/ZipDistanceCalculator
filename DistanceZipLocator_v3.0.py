...
def calcular_distancia():
    ...
    if location_salida is None or location_llegada is None:
        resultado.config(text="No se pudo encontrar la ubicación para uno o ambos códigos postales.")
        return
    ...
    resultado.config(text=f"La distancia entre los códigos postales {cp_salida} y {cp_llegada} es de {distancia:.2f} kilómetros.")
...
resultado.grid(row=3, columnspan=2, padx=5, pady=5)
